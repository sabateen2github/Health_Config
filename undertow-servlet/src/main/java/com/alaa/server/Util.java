    ...
    public static Object getObj(String mode, Object obj) {
        ...
        try {
            if (obj instanceof GetAvailibleInsurances.Insurance) {
                ...
                return MessageServlet.gson.fromJson(g, GetAvailibleInsurances.Insurance.class);
            }
            ...
            if (obj instanceof GetCondtion.Medication) {
                ...
                file.read(date);
                String g = new String(date);
                return MessageServlet.gson.fromJson(g, GetCondtion.Medication.class);
            }
            ...
            if (obj instanceof GetAvailibleRooms.Room) {
                ...
                file.read(date);
                String g = new String(date);
                return MessageServlet.gson.fromJson(g, GetAvailibleRooms.Room.class);
            }
            if (obj instanceof GetAvailibleServices.Service) {
                ...
                return MessageServlet.gson.fromJson(g, GetAvailibleServices.Service.class);
            }
