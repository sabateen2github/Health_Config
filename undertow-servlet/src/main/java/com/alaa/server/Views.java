...
public class Views {
    ...
    public static String handleBook(String json) {
        ...
        try {
            com.health.objects.BookAppointment.Request request = MessageServlet.gson.fromJson(json, com.health.objects.BookAppointment.Request.class);
    ...
    private static GetAvailibleRooms.Room getRoom(long room_id) throws FileNotFoundException, IOException {
        ...
        String g = new String(date, "UTF-8");
        room = MessageServlet.gson.fromJson(g, GetAvailibleRooms.Room.class);
        room_details.close();
        return room;
    }
    ...
    public static String handleDoneRequest(String json) {
        String res = null;
        try {
            com.health.objects.DoneRequest.Request request = MessageServlet.gson.fromJson(json, com.health.objects.DoneRequest.Request.class);
            Patient p = getPatient(request.patient_id);
            com.health.objects.GetProcedure.Procedure c = Util.findProc(request.procedure_id, p);
            if (c == null) {
                return Strings.SUCCESS;
 ...
 /*
    ...
    public static String handlePayService(String json) {
        String res = null;
        try {
            com.health.objects.PayForService.Request request = MessageServlet.gson.fromJson(json, com.health.objects.PayForService.Request.class);
            Patient p = getPatient(request.patient_id);
            com.health.objects.GetProcedure.Procedure c = Util.findProc(request.procedure_id, p);
            if (c == null) {
                return Strings.SUCCESS;
    ...
    public static boolean handleReset(String json) {
        try {
            MessageServlet.isResetting = true;
            PathsMine.reset();
            MessageServlet.isResetting = false;
            return true;
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String handleEnterLine(String json) {
        String res = null;
        try {
            com.health.objects.EnterTheLine.Request request = MessageServlet.gson.fromJson(json, com.health.objects.EnterTheLine.Request.class);
            Patient p = getPatient(request.patient_id);
            com.health.objects.GetProcedure.Procedure c = Util.findProc(request.procedure_id, p);
            if (c == null) {
                return Strings.SUCCESS;
    ...
    public static String handlePatientHandle(String json) {
        ...
        try {
            com.health.objects.HandlePatient.Request request = MessageServlet.gson.fromJson(json, com.health.objects.HandlePatient.Request.class);
    ...
    public static String handleSkipTime(String json) {
        ...
        String res = null;
        try {
            com.health.objects.SkipTime.Request request = MessageServlet.gson.fromJson(json, com.health.objects.SkipTime.Request.class);
    ...
    public static String handleStopProcedure(String json) {
        ...
        try {
            ...
            com.health.objects.StopProcedure.Request request = MessageServlet.gson.fromJson(json, com.health.objects.StopProcedure.Request.class);
            Patient p = getPatient(request.patient_id);
            com.health.objects.GetProcedure.Procedure c = Util.findProc(request.procedure_id, p);
            if (c == null) {
                return Strings.SUCCESS;
    ...
    private static MedTeam getMedTeam(long id) throws FileNotFoundException, IOException {
        ...
        file.read(date);
        String g = new String(date, "UTF-8");
        t = MessageServlet.gson.fromJson(g, MedTeam.class);
        file.close();
        return t;
    }
    ...
    private static void updateMedTeam(MedTeam team) throws IOException {
        ...
        file.setLength(0);
        byte[] data = MessageServlet.gson.toJson(team).getBytes("UTF-8");
    ...
    private static Session getSession(long id) {
        ...
        try {
            ...
            room_details.read(date);
            String g = new String(date, "UTF-8");
            s = MessageServlet.gson.fromJson(g, Session.class);
            room_details.close();
            return s;
    ...
    private static Session createSession(List<com.health.objects.GetAvailibleServices.Service> services) {
        ...
        try {
            ...
            byte[] data = MessageServlet.gson.toJson(s).getBytes("UTF-8");
            int size = data.length;
    ...
    private static AppointmentRoom getAppointmentRoom(long app_id, long room_id) {
        try {
            ...
            app_file.read(date);
            String g = new String(date, "UTF-8");
            AppointmentRoom app = MessageServlet.gson.fromJson(g, AppointmentRoom.class);
            app_file.close();
            return app;
        } catch (IOException ex) {
            Logger.getLogger(Views.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private static void updateAppointmentRoom(AppointmentRoom se, long room_id) {
        try {
            ...
            byte[] data = MessageServlet.gson.toJson(se).getBytes("UTF-8");
            int size = data.length;
    ...
    public static String handleStopCondtion(String json) {
        ...
        try {
            ...
            com.health.objects.StopCondtion.Request request = MessageServlet.gson.fromJson(json, com.health.objects.StopCondtion.Request.class);
            Patient p = getPatient(request.patient_id);
    ...
    public static String handleStartProcedure(String json) {
        ...
        try {
            com.health.objects.StartProcedure.Request request = MessageServlet.gson.fromJson(json, com.health.objects.StartProcedure.Request.class);
            Patient p = getPatient(request.patient_id);
    ...
    public static String handleStartCondtion(String json) {
        ...
        try {
            ...
            com.health.objects.StartCondtion.Request request = MessageServlet.gson.fromJson(json, com.health.objects.StartCondtion.Request.class
            );
            Patient p = getPatient(request.patient_id);
            ...
            res = MessageServlet.gson.toJson(ress);
    ...
    private static Patient getPatient(long id) throws FileNotFoundException, IOException {
        ...
        Patient patient = MessageServlet.gson.fromJson(json, Patient.class);
        return patient;
    }
    ...
    public static String handleUpdateProcedure(String json) {
        String res = null;
        try {
            com.health.objects.UpdateProcedure.Request request = MessageServlet.gson.fromJson(json, com.health.objects.UpdateProcedure.Request.class);
            Patient p = getPatient(request.patient_id);
            com.health.objects.GetProcedure.Procedure c = request.procedure;
            if (c == null) {
                return Strings.SUCCESS;
    ...
    public static String handleInstallServices(String json) {
        ...
        try {
            ...
            com.health.objects.InstallServices.Request request = MessageServlet.gson.fromJson(json, com.health.objects.InstallServices.Request.class);
            ...
            for (int i = 0; i < request.services.size(); i++) {
                ...
                if (MessageServlet.Signature == request.services.get(i).service_id) {
                ...
                String service = MessageServlet.gson.toJson(request.services.get(i));
            ...
            list.close();
            res = MessageServlet.gson.toJson(response, (new TypeToken<ArrayList<Long>>() {
            }).getType());
    ...
    public static String handleInstallInsurances(String json) {
        ...
        try {
            ...
            com.health.objects.InstallInsurances.Request request = MessageServlet.gson.fromJson(json, com.health.objects.InstallInsurances.Request.class);
            ...
            for (int i = 0; i < request.insurances_paths.size(); i++) {
                ...
                if (request.insurances_paths.get(i).insurance_id == MessageServlet.Signature) {
                    id = Util.generateID(ids);
                    list.writeLong(id);
                }
                ...
                byte[] data = MessageServlet.gson.toJson(request.insurances_paths.get(i)).getBytes("UTF-8");
                int size = data.length;
    ...
    public static String handleInstallMedications(String json) {
        ...
        try {
            ...
            com.health.objects.InstallMedication.Request request = MessageServlet.gson.fromJson(json, com.health.objects.InstallMedication.Request.class);
            ...
            for (int i = 0; i < request.medications.size(); i++) {
                ...
                if (request.medications.get(i).medication_id == MessageServlet.Signature) {
                    id = Util.generateID(ids);
                    list.writeLong(id);
                }
                respose.add(id);
                ...
                byte[] data = MessageServlet.gson.toJson(request.medications.get(i)).getBytes("UTF-8");
                int size = data.length;
            ...
            list.close();
            res = MessageServlet.gson.toJson(respose, (new TypeToken<ArrayList<Long>>() {
            }).getType());
    ...
    public static String handleInstallRooms(String json) {
        String res = null;
        try {
            com.health.objects.InstallRooms.Request request = MessageServlet.gson.fromJson(json, com.health.objects.InstallRooms.Request.class
            );
            ...
            for (int i = 0; i < request.rooms.size(); i++) {
                ...
                if (request.rooms.get(i).room_id == MessageServlet.Signature) {
                    id = Util.generateID(ids);
                    list.writeLong(id);
                }
                respose.add(id);
                ...
                room_details.setLength(0);
                byte[] data = MessageServlet.gson.toJson(room).getBytes("UTF-8");
                int size = data.length;
                room_details.writeInt(size);
                room_details.write(data);
                room_details.close();
    ...
    public static String handleInstallCondtions(String json) {
        ...
        try {
            ...
            com.health.objects.InstallCondtionsTemplate.Request request = MessageServlet.gson.fromJson(json, com.health.objects.InstallCondtionsTemplate.Request.class
            );
            ...
            for (int i = 0; i < request.condtions.size(); i++) {
                ...
                byte[] data = MessageServlet.gson.toJson(cond).getBytes("UTF-8");
                int size = data.length;
    ...
    public static String handleInstallProcedures(String json) {
        ...
        try {
            ...
            com.health.objects.InstallProceduresTemplates.Request request = MessageServlet.gson.fromJson(json, com.health.objects.InstallProceduresTemplates.Request.class);
            ...
            for (int i = 0; i < request.procedures.size(); i++) {
                ...
                byte[] data = MessageServlet.gson.toJson(proc).getBytes("UTF-8");
                int size = data.length;
    ...
    public static String handleInstallSchedules(String json) {
        ...
        try {
            com.health.objects.InstallSchedules.Request request = MessageServlet.gson.fromJson(json, com.health.objects.InstallSchedules.Request.class
            );
            ...
            for (AppointmentRoom ap : r) {
                ...
                for (int i = 0; i < apps.size(); i++) {
                    if (Util.isAfter(apps.get(i).date, ap.date)) {
                        ...
                        byte[] data = MessageServlet.gson.toJson(ap).getBytes("UTF-8");
                        int size = data.length;
                        app_file.writeInt(size);
                        app_file.write(data);
                        app_file.close();
    ...
    public static String handleInstallPatient(String json) {
        ...
        try {
            com.health.objects.InstallPatientsAccounts.Request request = MessageServlet.gson.fromJson(json, com.health.objects.InstallPatientsAccounts.Request.class
            );
            ...
            for (int i = 0; i < request.patients.size(); i++) {
                ...
                if (data.insurance_id != 0) {
                    ...
                    for (int x = 0; x < ids.size(); x++) {
                        ...
                        if (ids.get(x) == data.insurance_id) {
                            ...
                            String g = new String(date, "UTF-8");
                            data.insurance_path = MessageServlet.gson.fromJson(g, GetAvailibleInsurances.Insurance.class).insurance_path;
                            insurance_file.close();
                            break;
                        }
                    }
                ...
                byte[] datad = MessageServlet.gson.toJson(patient).getBytes("UTF-8");
    ...
    public static String handleInstallMeDTeam(String json) {
        ...
        try {
            com.health.objects.InstallMedTeamAccounts.Request request = MessageServlet.gson.fromJson(json, com.health.objects.InstallMedTeamAccounts.Request.class
            );
            ...
            for (int i = 0; i < request.med_team.size(); i++) {
                ...
                byte[] datad = MessageServlet.gson.toJson(t).getBytes("UTF-8");
                int size = datad.length;
                file.writeInt(size);
                file.write(datad);
                file.close();
    ...
    public static String handleGetAvailibleCondtions(String json) {
        ...
        try {
            ...
            for (int i = 0; i < ids.size(); i++) {
                ...
                String g = new String(date, "UTF-8");
                condtions.add(MessageServlet.gson.fromJson(g, GetCondtion.Condtion.class));
                condtion_file.close();
            }
            ...
            res = MessageServlet.gson.toJson(cp);
    ...
    public static String handleGetAvailibleProcedures(String json) {
        ...
        try {
            ...
            com.health.objects.GetAvailibleProcedure.Request req = MessageServlet.gson.fromJson(json, com.health.objects.GetAvailibleProcedure.Request.class);
            ...
            for (int i = 0; i < ids.size(); i++) {
                ...
                proc_file.read(date);
                String g = new String(date, "UTF-8");
                procs.add(MessageServlet.gson.fromJson(g, GetProcedure.Procedure.class));
                proc_file.close();
                if (req.for_patient) {
            ...
            res = MessageServlet.gson.toJson(procs);
    ...
    public static String handleGetTime(String json) {
        ...
        try {
            ...
            res = MessageServlet.gson.toJson(t, Time.class);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static String handleGetAvailibleRooms(String json) {
        ...
        try {
            ...
            res = MessageServlet.gson.toJson(r);
    ...
    public static String handleGetAvailibleServices(String json) {
        ...
        try {
            ...
            for (int i = 0; i < ids.size(); i++) {
                ...
                String g = new String(date, "UTF-8");
                services.add(MessageServlet.gson.fromJson(g, GetAvailibleServices.Service.class));
                service_file.close();
            }
            ...
            res = MessageServlet.gson.toJson(ser);
    ...
    public static String handleGetAvailibleInsurances(String json) {
        ...
        try {
            ...
            for (int i = 0; i < ids.size(); i++) {
                ...
                insurance_file.read(date);
                String g = new String(date, "UTF-8");
                insurances.add(MessageServlet.gson.fromJson(g, GetAvailibleInsurances.Insurance.class));
                insurance_file.close();
            }
    ...
    public static String handleGetAvailibleMedications(String json) {
        ...
        try {
            ...
            for (int i = 0; i < ids.size(); i++) {
                ...
                String g = new String(date, "UTF-8");
                medications.add(MessageServlet.gson.fromJson(g, GetCondtion.Medication.class));
                medication_file.close();
            }
    ...
    public static String handleCheckIDPass(String json) {
        ...
        try {
            com.health.objects.CheckAccountIdPass.Request request = MessageServlet.gson.fromJson(json, com.health.objects.CheckAccountIdPass.Request.class);
    ...
    public static String handleGetCondtion(String json) {
        ...
        try {
            com.health.objects.GetCondtion.Request request = MessageServlet.gson.fromJson(json, com.health.objects.GetCondtion.Request.class);
            Patient p = getPatient(request.patient_id);
    ...
    public static String handleGetProcedure(String json) {
        ...
        try {
            com.health.objects.GetProcedure.Request request = MessageServlet.gson.fromJson(json, com.health.objects.GetProcedure.Request.class);
            Patient p = getPatient(request.patient_id);
    ...
    public static String handleGetActiveFeedBack(String json) {
        ...
        try {
            ...
            com.health.objects.GetActiveFeedbackList.Request request = MessageServlet.gson.fromJson(json, com.health.objects.GetActiveFeedbackList.Request.class);
            ...
            if (m != null) {
                ...
                res = MessageServlet.gson.toJson(patients);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String handleGetActiveSmartFeeds(String json) {
        ...
        try {
            com.health.objects.GetSmartFeedBackList.Request request = MessageServlet.gson.fromJson(json, com.health.objects.GetSmartFeedBackList.Request.class);
    ...
    public static String handleAffectedAppointments(String json) {
        ...
        try {
            com.health.objects.GetAffectedAppointments.Request request = MessageServlet.gson.fromJson(json, com.health.objects.GetAffectedAppointments.Request.class);
            ...
            res = MessageServlet.gson.toJson(affected, new TypeToken<ArrayList<GetAffectedAppointments.AffectedAppointment>>() {
            }.getType());
    ...
    public static String handleGetFullAppointment(String json) {
        String res = null;
        try {
            com.health.objects.GetFullAppointment.Request request = MessageServlet.gson.fromJson(json, com.health.objects.GetFullAppointment.Request.class);
            ...
            res = MessageServlet.gson.toJson(full);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String handleGetActiveCondtions(String json) {
        ...
        try {
            ...
            com.health.objects.GetActiveCondtions.Request request = MessageServlet.gson.fromJson(json, com.health.objects.GetActiveCondtions.Request.class);
            ...
            res = MessageServlet.gson.toJson(condtions);
    ...
    public static String handleCancelAppointment(String json) {
        String res = null;
        try {
            com.health.objects.CancelAppointment.Request request = MessageServlet.gson.fromJson(json, com.health.objects.CancelAppointment.Request.class);
    ...
    public static String handleGetActiveProcedures(String json) {
        ...
        try {
            com.health.objects.GetActiveProcedures.Request request = MessageServlet.gson.fromJson(json, com.health.objects.GetActiveProcedures.Request.class);
            Patient p = getPatient(request.patient_id);
    ...
    public static String handleGetNotifications(String json) {
        String res = null;
        try {
            com.health.objects.GetNotifications.Request request = MessageServlet.gson.fromJson(json, com.health.objects.GetNotifications.Request.class);
            Patient p = getPatient(request.patient_id);
            ...
            res = MessageServlet.gson.toJson(notis);
    ...
    public static String handleSetLang(String json) {
        String res = null;
        try {
            com.health.objects.setLang.Request request = MessageServlet.gson.fromJson(json, com.health.objects.setLang.Request.class);
            Patient p = getPatient(request.id);
            p.lang = request.lang;
            updateLastTimeModified(p);
            savePatient(p);
            res = MessageServlet.gson.toJson(Strings.SUCCESS);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static String handleGetPersonalData(String json) {
        String res = null;
        try {
            com.health.objects.GetPersonalData.Request request = MessageServlet.gson.fromJson(json, com.health.objects.GetPersonalData.Request.class);
            Patient p = getPatient(request.patient_id);
    ...
    public static String handleGetMedData(String json) {
        String res = null;
        try {
            com.health.objects.GetMedData.Request request = MessageServlet.gson.fromJson(json, com.health.objects.GetMedData.Request.class);
    ...
    public static String handleGetRoomsAppointments(String json) {
        String res = null;
        try {
            com.health.objects.GetRoomsAppointments.Request request = MessageServlet.gson.fromJson(json, com.health.objects.GetRoomsAppointments.Request.class);
    ...
    public static String handleGetCurrentRoomAppointments(String json) {
        ...
        try {
            com.health.objects.GetRoomCurrentAppointment.Request request = MessageServlet.gson.fromJson(json, com.health.objects.GetRoomCurrentAppointment.Request.class);
            ...
            if (list.size() > 0) {
                ...
                res = MessageServlet.gson.toJson(app);
    ...
    private static Patient savePatient(Patient p) {
        ...
        try {
            ...
            byte[] datad = MessageServlet.gson.toJson(p).getBytes("UTF-8");
            int size = datad.length;
            file.writeInt(size);
            file.write(datad);
            file.close();
    ...
    private static void updatePatient(long id) throws IOException {
        ...
        String json = g;
        file.close();
        Patient p = MessageServlet.gson.fromJson(json, Patient.class);
        updatePatient(p);
    }
                ...
                for (GetProcedure.Procedure procedure : cond.procedures) {
                    ...
                    if (procedure.type == Types.Type_Procedure_Condtion_Routine) {
                        ...
                        if (Util.isAfter(g2, p.lastTimeUpdated) && Util.isAfter(PathsMine.getCurrentTime(), g1)) {
                            ...
                            for (int t = 1; t <= times; t++) {
                                com.health.objects.GetProcedure.Procedure c = MessageServlet.gson.fromJson(MessageServlet.gson.toJson(procedure), GetProcedure.Procedure.class);
